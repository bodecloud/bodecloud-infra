...
This prompt exists as a docs-side mirror of the `.github` source.
Use it as a reusable writing contract, but keep the current repo docs and
master plan authoritative when the prompt references repository context.
