  ...
  group "media-management" {
    ...
    task "jellyseer" {
      ...
      service {
        ...
        tags = [
          "traefik.enable=true",
          "traefik.http.routers.jellyseer.rule=Host(`jellyseer.${NOMAD_META_DOMAIN}`) || Host(`jellyseer.${NOMAD_META_DUCKDNS_SUBDOMAIN}.duckdns.org`) || Host(`jellyseer.${NOMAD_META_TS_HOSTNAME}.duckdns.org`)",
    ...
    task "seanime" {
      ...
      service {
        ...
        tags = [
          ...
          "traefik.http.routers.seanime.rule=Host(`seanime.${NOMAD_META_DOMAIN}`) || Host(`seanime.${NOMAD_META_DUCKDNS_SUBDOMAIN}.duckdns.org`) || Host(`seanime.${NOMAD_META_TS_HOSTNAME}.duckdns.org`)",
    ...
    task "tautulli" {
      ...
      service {
        ...
        tags = [
          ...
          "traefik.http.routers.tautulli.rule=Host(`tautulli.${NOMAD_META_DOMAIN}`) || Host(`tautulli.${NOMAD_META_DUCKDNS_SUBDOMAIN}.duckdns.org`) || Host(`tautulli.${NOMAD_META_TS_HOSTNAME}.duckdns.org`)",
  ...
  group "security-monitoring" {
    ...
    task "vaultwarden" {
      ...
      service {
        ...
        tags = [
          "traefik.enable=true",
          "traefik.http.routers.vaultwarden.rule=Host(`vaultwarden.${NOMAD_META_DOMAIN}`) || Host(`vaultwarden.${NOMAD_META_DUCKDNS_SUBDOMAIN}.duckdns.org`) || Host(`vaultwarden.${NOMAD_META_TS_HOSTNAME}.duckdns.org`)",
