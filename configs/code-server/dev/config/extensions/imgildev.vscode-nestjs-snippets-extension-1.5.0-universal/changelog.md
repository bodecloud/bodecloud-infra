...
- Refine extension metadata in package.json for better description and keywords
- Enhance snippets with detailed descriptions for decorators, pipes, and modules
- Improve code snippets for JWT and Passport modules with better configuration examples
- Update testing snippets to use async expectations and improved structure
- Add missing descriptions to various GraphQL and WebSocket snippets
- Correct and standardize snippet bodies for consistency and clarity
...
[unreleased]: https://github.com/ManuelGil/vscode-nestjs-snippets/compare/v1.5.0...HEAD
[1.5.0]: https://github.com/ManuelGil/vscode-nestjs-snippets/compare/v1.4.0...v1.5.0
