...
class DTOController {
    ...
    getAnnotationsRegex() {
        ...
        const escapedAnnotations = this.annotations.map((annotation) => annotation.replace(/[.*+?^${}()|[\]\\]/g, '\\$&'));
...
exports.DTOController = DTOController;
//# sourceMappingURL=dto.controller.js.map