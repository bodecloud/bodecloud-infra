...
plex_url="https://plex.bolabaden.org" # If you're using zurg inside a Docker container, by default it is 172.17.0.1:32400
token="doA-LAX9Ws2xz4T3sxLW" # open Plex in a browser, open dev console and copy-paste this: window.localStorage.getItem("myPlexAccessToken")
